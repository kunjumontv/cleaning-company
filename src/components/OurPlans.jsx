...
const OurPlans = () => {
  return (
    <div className="bg-greenish-blue py-8 md:py-28">
      <div className="lg:mx-28 grid grid-cols-1 md:grid-cols-2 gap-4 md:items-center">
        <div className="flex flex-col items-center md:items-start gap-4 my-8 px-4 md:w-[430px]">
          ...
          <button className="bg-white text-greenish-blue py-4 px-8 w-4/5 md:w-min rounded-full text-2xl md:text-xl md:px-7 md:py-3.5 whitespace-nowrap transition hover:text-white hover:bg-transparent hover:border border-white">
            Choose Your Plan
          </button>
        </div>
