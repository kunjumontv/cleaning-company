...
const Navbar = () => {
  ...
  return (
    <>
      {/* Desktop View Navbar */}
      <nav className="lg:mx-28 md:mt-10 md:grid md:grid-cols-[250px,1fr] flex justify-between bg-subtle-yellow p-6 md:fixed left-0 right-0">
      ...
      {/* Mobile View Navbar */}
      {!toggleMenuButton && (
        <nav className="md:hidden bg-subtle-yellow inset-0 absolute text-2xl">
