  ...
  return (
    <div className="mt-16 md:py-20 bg-greenish-blue text-white">
      ...
      <div className="flex flex-col gap-4 mt-8 md:flex-row md:justify-center md:mt-10 md:gap-6 md:px-28">
        <div className="relative">
          <Image
            ...
            className="w-[95%] mx-auto md:w-auto rounded-md"
          />
          <div className="absolute inset-0 bg-black opacity-40 round-md"></div>
        ...
        <div className="relative">
          <Image
            ...
            height={60}
            sizes="(max-width: 768px) 100vw, 350px"
            className="w-[95%] mx-auto md:w-auto rounded-md hover:scale-105 "
          />
          <div className="absolute inset-0 bg-black opacity-40 round-md"></div>
          <span className="absolute bottom-4 text-3xl text-white ml-8 antialiased">
            Laundry
        ...
        <div className="relative">
          <Image
            ...
            height={60}
            sizes="(max-width: 768px) 100vw, 350px"
            className="w-[95%] mx-auto md:w-auto rounded-md object-cover"
          />
          <div className="absolute inset-0 bg-black opacity-40 round-md"></div>
          <span className="absolute bottom-4 text-3xl text-white ml-8 antialiased">
            Deep Cleaning
      ...
      <div className="text-center my-10 pb-10 md:pb-0 transition-all">
        <button className="text-2xl md:text-lg bg-white text-greenish-blue px-16 py-5 md:px-14 md:py-4 rounded-full transition-all hover:bg-transparent hover:text-white hover:border hover:border-white">
          See All Services
        </button>
      </div>
    </div>
